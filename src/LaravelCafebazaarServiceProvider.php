...
class LaravelCafebazaarServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            /*$this->publishes([
                __DIR__.'/../resources/views' => resource_path('views/vendor/laravel-cafebazaar'),
            ], 'views');*/

            // Publishing assets.
            /*$this->publishes([
                __DIR__.'/../resources/assets' => public_path('vendor/laravel-cafebazaar'),
            ], 'assets');*/

            // Publishing the translation files.
            /*$this->publishes([
                __DIR__.'/../resources/lang' => resource_path('lang/vendor/laravel-cafebazaar'),
            ], 'lang');*/
    ...
    public function register()
    {
        ...
        $this->mergeConfigFrom(__DIR__.'/../config/config.php', 'laravel-cafebazaar');
